...
> [!TIP]
> Danh sách 16 test case dưới đây được đồng bộ chính xác 100% với file kịch bản **[Product_Search_Pagination_Postman_Collection.json](file:///c:/shoeshopp/Testing/test_cases/black_box/product_search_pagination/Product_Search_Pagination_Postman_Collection.json)** và các file nhóm tương ứng.
